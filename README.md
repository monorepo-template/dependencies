...
| [![nyc-config](https://github.com/CharlesStover/monorepo-template-dependencies/actions/workflows/nyc-config.yml/badge.svg?branch=main&event=push)](https://github.com/CharlesStover/monorepo-template-dependencies/actions/workflows/nyc-config.yml) | [![version](https://img.shields.io/npm/v/@monorepo-template/nyc-config.svg)](https://www.npmjs.com/package/@monorepo-template/nyc-config) | [![downloads](https://img.shields.io/npm/dt/@monorepo-template/nyc-config.svg)](https://www.npmjs.com/package/@monorepo-template/nyc-config) |
