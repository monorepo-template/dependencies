...
function getPackageJson() {
    var path = join(CWD, 'package.json');
...
var JSON_PLUGIN = json();

var NO_JSX_RUNTIME_PLUGIN = prepend("import React from 'react';\n", {
    include: '**/*.tsx',
});

var NODE_RESOLVE_PLUGIN = nodeResolve({
