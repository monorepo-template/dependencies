...
var libCoverage__default = /*#__PURE__*/_interopDefaultLegacy(libCoverage);
...
function getCoverageMap(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var map, nyc, _loop_1, paths_1, paths_1_1, path$1, e_1_1;
        var e_1, _b;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    map = libCoverage__default["default"].createCoverageMap({});
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    handlePMap = function (file) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (enableLogging) {
                                                        console.log("Merging coverage file: ".concat(path.join(path$1, file)));
                                                    }
                                                    return [4, nyc.coverageFileLoad(file, path$1)];
                                                case 1:
                                                    report = _a.sent();
                                                    map.merge(report);
                                                    return [2];
                                    ...
                                    return [4, nyc.coverageFiles(path$1)];
                                case 1:
                                    files = _e.sent();
                                    return [4, pMap__default["default"](files, handlePMap, P_MAP_OPTIONS)];
                                case 2:
                                    _e.sent();
                                    _d = map;
                                ...
                                case 3:
                                    ...
                                    if (nyc.config.excludeAfterRemap) {
                                        filterByShouldInstrument = function (filename) {
                                            ...
                                            if (enableLogging) {
                                                console.log("Excluding coverage file after remap: ".concat(path.join(path$1, filename)));
                                            }
                                            return true;
                                        };
                ...
                case 2:
                    ...
                    path$1 = paths_1_1.value;
                    return [5, _loop_1(path$1)];
                case 3:
                    _c.sent();
                    _c.label = 4;
                case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    map = _h.sent();
                    OUTPUT_DIR = path.join(workingDirectory, outputDirectory);
                    return [4, makeDir__default["default"](OUTPUT_DIR)];
                case 2:
                    _h.sent();
                    OUTPUT_FILE = path.join(OUTPUT_DIR, outputFile);
                    if (enableLogging) {
                        console.log("Writing coverage file: ".concat(OUTPUT_FILE));
                    }
                    mapStr = JSON.stringify(map, null, SPACES_COUNT);
                    fs.writeFileSync(OUTPUT_FILE, mapStr, 'utf8');
                    return [2];
            }
        });
    });
